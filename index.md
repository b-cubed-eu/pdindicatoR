...
[`retrieve_example_data()`](https://b-cubed-eu.github.io/pdindicatoR/reference/retrieve_example_data.md)
...
![Phylogenetic tree](reference/figures/unnamed-chunk-2-1.png)
...
to retrieve the corresponding GBIF id’s.
...
to append the `ott_id`’s as a new variable to the provided datacube, by
joining on `gbif_id`.
...
![PD map](reference/figures/unnamed-chunk-9-1.png)
...
![](reference/figures/unnamed-chunk-11-2.png)
