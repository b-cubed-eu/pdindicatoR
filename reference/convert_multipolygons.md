...
#> Writing layer `file21b117913bc7' to data source 
#>   `/tmp/RtmpGoIJ6N/file21b117913bc7.gpkg' using driver `GPKG'
#> Writing 1149 features with 4 fields and geometry type Polygon.
#> Reading layer `file21b117913bc7' from data source 
#>   `/tmp/RtmpGoIJ6N/file21b162db4608.gpkg' using driver `GPKG'
