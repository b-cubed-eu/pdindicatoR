...
#> Bounding box:  xmin: 3948585 ymin: 3065773 xmax: 4049889 ymax: 3141858
#> Projected CRS: ETRS89-extended / LAEA Europe
#> Writing layer `file21b11fc4f6e7' to data source 
#>   `/tmp/RtmpGoIJ6N/file21b11fc4f6e7.gpkg' using driver `GPKG'
#> Writing 1149 features with 4 fields and geometry type Polygon.
#> Reading layer `file21b11fc4f6e7' from data source 
#>   `/tmp/RtmpGoIJ6N/file21b19cefbad.gpkg' using driver `GPKG'
