...
This outlines how to propose a change to pdindicatoR. For a detailed
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("b-cubed-eu/pdindicatoR", fork = TRUE)`.
...
Please note that the pdindicatoR project is released with a [Contributor
Code of
Conduct](https://b-cubed-eu.github.io/pdindicatoR/CODE_OF_CONDUCT.md).
